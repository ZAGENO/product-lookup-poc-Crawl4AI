# services/ollama_content_filter.py
import logging
import json
import aiohttp
import os
...
class OllamaContentFilter:
    ...
    async def enrich_content(self, markdown_content: str, product: product_search_pb2.ProductData) -> Dict[str, str]:
        ...
        try:
            # Create enhanced prompt for medical/lab products
    ...
    def _create_medical_extraction_prompt(self, product, markdown_content):
        ...
        1. SKU ID (Stock Keeping Unit):
           ...
           - Check product specifications, technical details, or product information sections
           - For lab equipment: often found near "Product Information" or "Specifications"
        ...
        2. Part Number:
           ...
           - Often found in technical specifications or product details
           - For pipette tips: look for volume specifications like "10µL", "100µL"
        ...
        3. Brand/Manufacturer:
           ...
           - Check headers, product titles, or company information sections

        4. Price:
           - Look for: Current price, Sale price, List price
           - Format: $XXX.XX, $XXX, or similar currency formats
           - Check pricing sections, product cards, or checkout areas
        ...
        5. Description:
           ...
           - Keep under 200 characters for summary

        EXAMPLES OF MEDICAL/LAB PRODUCT PATTERNS:
        - Pipette tips: "10µL pipette tips", "100µL universal fit tips"
        - Lab equipment: "Centrifuge", "Microscope", "Incubator"
        - Part numbers: "960A/10", "0.1-10uL", "BMSP7700T10M"
        - SKU patterns: "02681437", "ABC123", "123-456"
